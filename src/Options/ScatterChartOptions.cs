...
public class ScatterChartOptions : IScatterChartOptions
{
    private ScatterChartSettings _settings = new();
    internal ScatterChartSettings ReturnSettings() => _settings;
    public string? title
    {
        set
        {
    ...
    public string? pointShape
    {
        set
        {
            _settings.pointShape = value ?? gcPointShapeType.Circle;
        }
    }
